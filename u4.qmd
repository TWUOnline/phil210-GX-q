...
- Read the following articles of the textbook “Readings in Moral Philosophy” by Jonathan Wolff [-@wolffReadingsMoralPhilosophy2018].
...
[Watch: *What is the difference between rape and sexual assault or harassment, in the US?*](https://www.youtube.com/watch?v=0T3EMaKpGSQ){target="_blank"} [-@clarifybyplaybacWhatDifferenceRape2017] <!-- Auto title, auto embed--> 

{{< video https://www.youtube-nocookie.com/embed/0T3EMaKpGSQ >}}
...
[Watch: *When Your Date Doesn't Hear The Word "No"*](https://www.youtube.com/watch?v=qj_OcHp7zm8){target="_blank"} [-@as/isWhenYourDate2016] <!-- Auto title, auto embed--> 

{{< video https://www.youtube-nocookie.com/embed/qj_OcHp7zm8 >}}
...
[Watch: *U of A Sexual Assault Centre: Let’s Talk: Alcohol and Sexual Assault*](https://www.youtube.com/watch?v=kU_TVp6_slw){target="_blank"} [-@uofastudentlifeSexualAssaultCentre2016] <!-- Auto title, auto embed--> 

{{< video https://www.youtube-nocookie.com/embed/kU_TVp6_slw >}}

[Watch: *Washington Post-Kaiser poll*](https://www.washingtonpost.com/video/national/college-students-define-sexual-consent/2015/06/12/2c06cd5e-114a-11e5-a0fe-dccfea4653ee_video.html){target="_blank"} [-@orensteinCollegeStudentsDefine2015]

::: {.video-container}

<iframe width="560" height="315" scrolling='no' src='https://www.washingtonpost.com/video/c/embed/2c06cd5e-114a-11e5-a0fe-dccfea4653ee' frameborder='0' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
...
Read the section on hookup culture, (pp. 316-328) of your textbook, *Readings in Moral Philosophy* by Jonathan Wolff [-@wolffReadingsMoralPhilosophy2018]. Take notes defining key terms and ideas. Study the chapter review summary, questions and key terms.
...
**Ethics Video (30%)** For this assignment, you’ll create a 2-minute video articulating a moral viewpoint on one of the following issues: Free speech or sexual morality (Units 3-4 topics). You should draw upon the readings from Units 3 and 4 to support your stance and make a concise case for your chosen viewpoint. Your Ethics Video should be submitted on Moodle by the end of this week 4. *See the Assessments section for more details on submitting your Ethics Video, as well as the grading criteria.* --> 
