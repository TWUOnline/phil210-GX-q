...
- Read the following articles of the textbook “Readings in Moral Philosophy” by Jonathan Wolff.
   - Introductory section on animal rights (pp. 426-27)
   - Immanuel Kant (pp. 428-29)
   - Animal rights by Peter Singer (pp. 429-435)
   - Animal rights by Roger Scruton (pp. 436-443)
...
Read the introductory section on animal rights (pp. 426-27) and the section by Immanuel Kant (pp. 428-29) in your textbook *“Readings in Moral Philosophy”* by Jonathan Wolff [-@wolffReadingsMoralPhilosophy2018]. As you read, take notes in your Learning Journal, defining key terms and explaining key concepts.

Next, choose from the following videos to learn more about key terms from this topic.

[Watch: *Non-Human Animals: Crash Course Philosophy*](https://www.youtube.com/watch?v=y3-BX-jN_Ac){target="_blank"} [-@crashcourseNonhumanAnimalsCrash2017].
...
[Watch: *Tea Consent (Clean)*](https://www.youtube.com/watch?v=fGoWLWS4-kU){target="_blank"} [-@blueseatstudiosTeaConsentClean2015] <!-- Auto title, auto embed--> 
...
[Watch: *What animals are thinking and feeling, and why it should matter | Carl Safina | TEDxMidAtlantic*](https://www.youtube.com/watch?v=-wkdH_wluhw){target="_blank"} [-@tedxtalksWhatAnimalsAre2016] <!-- Auto title, auto embed--> 
...
Read the section on animal rights by Peter Singer (pp. 429-435) in your textbook, *Readings in Moral Philosophy* by Jonathan Wolff [-@wolffReadingsMoralPhilosophy2018]. Take notes defining key terms and ideas. Study the chapter review summary, questions and key terms.

Next, choose from the following videos to learn more about key terms from this topic.

[Watch: *Personhood: Crash Course Philosophy #21*](https://www.youtube.com/watch?v=GxM9BZeRrUI){target="_blank"} [-@crashcoursePersonhoodCrashCourse2016]<!-- Auto title, auto embed--> 
...
[Watch: *Defining Speciesism with Peter Singer*](https://www.youtube.com/watch?v=k57F49ymmQg){target="_blank"} [-@animals&societyinstituteDefiningSpeciesismPeter2018].

{{< video https://www.youtube-nocookie.com/embed/k57F49ymmQg?si=TKM24UL_eqzpVUpw >}}

[Watch: *Peter Singer - Non-Human Animal Ethics - EA Global Melbourne 2015*](https://www.youtube.com/watch?v=TgRoZVT6kYc){target="_blank"} [-@sciencetechnology&thefuturePeterSingerNonhuman2015] <!-- Auto title, auto embed--> 
...
Read the section on animal rights by Roger Scruton (pp. 436-443) in your textbook *“Readings in Moral Philosophy”* by Jonathan Wolff [-@wolffReadingsMoralPhilosophy2018]. Take notes defining key terms and ideas. Study the chapter review summary, questions and key terms.

Next, watch the following videos to learn more about key terms from this topic.

[Watch: *Ethics: Moral Status*](https://www.youtube.com/watch?v=smuhAjyRbw0&t=3s){target="_blank"} [-@wirelessphilosophyPhilosophyEthicsMoral2014].
...
[Watch: *Ethics: Killing Animals for Food*](https://www.youtube.com/watch?v=3HAMk_ZYO7g){target="_blank"} [-@wirelessphilosophyPhilosophyEthicsKilling2014].
...
[Watch: *Artificial Intelligence & Personhood: Crash Course Philosophy*](https://www.youtube.com/watch?v=39EdqUbj92U){target="_blank"} [-@crashcourseArtificialIntelligencePersonhood2016] <!-- Auto title, auto embed--> 

{{< video https://www.youtube-nocookie.com/embed/39EdqUbj92U >}}

Then read the article from [Did A Robot Write This? How AI Is Impacting Journalism](https://www.forbes.com/sites/nicolemartin1/2019/02/08/did-a-robot-write-this-how-ai-is-impacting-journalism/?sh=286bd4eb7795){target="_blank"} [-@martinDidRobotWrite2019]
